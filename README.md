...
Want to experience the next generation of March? The v1.0.0 beta is now available at [beta.march.sh](https://beta.march.sh)!

This major update includes exciting new features like advanced search modes, PostgreSQL database, enhanced UI, and much more. Learn more about what's new in [Issue #680](https://github.com/miurla/march/issues/680).

Your feedback helps shape the future of March!
...
```bash
git clone git@github.com:[YOUR_GITHUB_ACCOUNT]/march.git
```
...
Host your own live version of March with Vercel, Cloudflare Pages, or Docker.

### Vercel

[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2Fmiurla%2Fmarch&env=OPENAI_API_KEY,TAVILY_API_KEY,UPSTASH_REDIS_REST_URL,UPSTASH_REDIS_REST_TOKEN)
